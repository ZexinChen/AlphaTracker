...
class args_class(object):
    ...
    def __init__(self):
        ...
        self.tracked_json = [
            '../Tracking/AlphaTracker/track_result/alphapose-results-forvis-tracked.json',
            ]
        ...
        self.gen_video_folder = './results/demo/'
        self.result_folder = './results/demo'
        ...
        ## the following code are for self-check
        assert len(self.imgdir) == len(self.tracked_json) == len(self.contdir) == len(self.videodir), 'The length of imgdir,tracked_json,contdir and videodir should be the same'
        for i in range(len(self.imgdir)):
            self.imgdir[i] = os.path.abspath(self.imgdir[i])
            self.tracked_json[i] = os.path.abspath(self.tracked_json[i])
            self.contdir[i] = os.path.abspath(self.contdir[i])
            self.videodir[i] = os.path.abspath(self.videodir[i])
