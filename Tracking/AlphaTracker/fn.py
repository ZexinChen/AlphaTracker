...
def vis_frame(frame, im_res, format='coco'):
    ...
    if format == 'coco':
        ...
        # p_color = [(0, 255, 255), (0, 191, 255),(0, 255, 102),(0, 77, 255), (0, 255, 0), #Nose, LEye, REye, LEar, REar
        p_color = [(60, 255, 255), (60, 191, 255),(60, 255, 102),(60, 77, 255), (60, 255, 0), #Nose, LEye, REye, LEar, REar
                    (77,255,255), (77, 255, 204), (77,204,255), (191, 255, 77), (77,191,255), (191, 255, 77), #LShoulder, RShoulder, LElbow, RElbow, LWrist, RWrist
                    (204,77,255), (77,255,204), (191,77,255), (77,255,191), (127,77,255), (77,255,127), (0, 255, 255)] #LHip, RHip, LKnee, Rknee, LAnkle, RAnkle, Neck
        # line_color = [(0, 215, 255), (0, 255, 204), (0, 134, 255), (0, 255, 50), 
        line_color = [(0, 0, 255), (0, 255, 0), (0, 0, 255), (60, 255, 50), 
                    (77,255,222), (77,196,255), (77,135,255), (191,255,77), (77,255,77), 
                    (77,222,255), (255,156,127), 
                    (0,127,255), (255,127,77), (0,77,255), (255,77,36)]
    elif format == 'mpii':
    ...
    # all_min_score = []
    # for human in im_res['result']:
    #     all_min_score.append(np.min(list(human['kp_score'])))
    # print(all_min_score)
    # if min(all_min_score)>0.3 and len(im_res['result'])==4:
    #     return []
    # ############# for data selection ####################
