...
"----------------------------- loading paths -----------------------------"
parser.add_argument('--yolo_model_path', dest='yolo_model_path', type=str, default='models/yolo/yolov3-spp.weights',
                    help='yolo_model_path')
parser.add_argument('--yolo_model_cfg', dest='yolo_model_cfg', type=str, default='yolo/cfg/yolov3-spp.cfg',
                    help='yolo_model_cfg')
parser.add_argument('--pose_model_path', dest='pose_model_path', type=str, default='./models/sppe/duc_se.pth',
                    help='pose_model_path')

parser.add_argument('--use_boxGT', type=int, default=0,
                    help='use_boxGT')
parser.add_argument('--gt_json', dest='gt_json', type=str, default='/home/zexin/project/mice/datasets/data_gen/original_annotation.json',
                    help='gt_json')
parser.add_argument('--img_json', dest='img_json', type=str, default='',
                    help='img_json contains image_filename-image_id pair, can use gt_json ')
